...
// Fri May 31 17:17:49 2019 by ROOT version 6.14/06
// from TTree KUAnalysis/KUAnalysis
// found on file: DYJetsToLL_M-4to50_HT-100to200_TuneCP5_13TeV-madgraphMLM-pythia8_Fall17.root
//////////////////////////////////////////////////////////
...
Int_t ewk::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ewk::LoadTree(Long64_t entry)
{
